...
methods for area, perimeter, string representation, deletion handling,
a static method to find the bigger rectangle based on area, and
a class method to create a square instance of Rectangle.
"""
